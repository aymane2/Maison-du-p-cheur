					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="thumb-wrapper">
								<span class="wish-icon"><i class="fa fa-heart-o"></i></span>
								<div class="img-box">
									<a href="Cannes 1.php"><img src="Img/Cannes/1-2.png" alt= ""></a>
								</div>
								<div class="thumb-content">
									<h4>Nikon DSLR</h4>									
									<div class="star-rating">
...
<div class="row featurette">
    ...
    <div class="col-md-5 order-md-1">
		<img src="Img/Supports-Cannes/1-1.png" alt="Logo HTML w3" style="width:500px; height:500px" class="img-thumbnail"> 

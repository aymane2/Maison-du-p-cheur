...
<div class="container bg-white">
    ...
    <?php
       $req = mysqli_query($data, "SELECT * FROM filaments");
        while($row = mysqli_fetch_assoc($req)){
    ?>
    <div class="row">
        <div class="col-lg-3 col-sm-6 d-flex flex-column align-items-center justify-content-center product-item my-3">
            <div class="product"> <a href="Filaments 1.php"><img src="products/<?= $row['image']?>"></a>
            ...
            <div class="item-price"><strike>$40.00</strike> <b><?= $row['prix']?>$</b></div>
        </div>
        <?php }?>

...
<div class="container bg-white">
    ...
    <?php
       $req = mysqli_query($data, "SELECT * FROM cannes");
        while($row = mysqli_fetch_assoc($req)){
    ?>
    <div class="row">
        <div class="col-lg-3 col-sm-6 d-flex flex-column align-items-center justify-content-center product-item my-3">
            <div class="product"> <a href="Cannes 1.php"><img src="products/<?= $row['image']?>"></a>
            ...
            <div class="item-price"><strike>$35.00</strike> <b><?= $row['prix']?>$</b></div>
        </div>
        <?php }?>
